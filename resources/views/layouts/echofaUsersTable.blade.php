        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @guest
                        <li style="color: #ffffff;font-family: '微软雅黑';"><a href="{{ route('login') }}">{{__('登录')}}</a></li>
                        {{--<li><a href="{{ route('register') }}">Register</a></li>--}}
                        @else
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" style="color: #FFFFFF; font-family: '微软雅黑'; font-size: 28px;letter-spacing:2.8px;
    padding-left:2.8px;" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true" v-pre>
                                    {{ Auth::user()->usercname }} <span class="caret"></span>
                                </a>
